          ...
          <main className="main-content">
                  ...
                  <div className="col-md-8">
                    <Slide>
                      ...
                      <p className="welcome-content">
                        ...
                        elit. Architecto labore alias nobis quam suscipit aut
                        nostrum neque quibusdam eligendi explicabo, animi, eius
                        beatae. Deleniti at, nam fuga accusamus non
                        reprehenderit. amet, consectetur adipisicing elit.
                        Architecto labore alias nobis quam suscipit aut nostrum
                        neque quibusdam eligendi explicabo, animi, eius beatae.
                        Deleniti at, nam fuga accusamus non reprehenderit.
                      </p>
                    </Slide>
                  </div>
                  <div className="col-md-4">
                    <Slide direction="right">
                      ...
                      >
                        <h3
                          id="latest-title"
                          className="latest-header transition"
                        >
                    ...
                    <div className="feature">
                      <header>
                        ...
                        <div className="feature-title-copy">
                          ...
                          <small className="feature-subtitle">
                            Our Mission
                          </small>
                        </div>
                      </header>
                      <p style={{ textAlign: "justify" }}>
                        Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Molestias doloremque, quis, eaque minus harum modi
                        eius veritatis consequuntur expedita impedit ad,
                        facilis. Asperiores assumenda aperiam atque, accusamus
                        cupiditate vero sit! Lorem ipsum dolor sit amet,
                        consectetur adipisicing elit. Molestias doloremque,
                        quis, eaque minus harum modi eius veritatis consequuntur
                        expedita impedit ad, facilis. Asperiores assumenda
                        aperiam atque, accusamus cupiditate vero sit!
                      </p>
            ...
            <div className="quote-container">
              <div
                ...
                style={{ background: "rgb(80, 80, 250)" }}
              >
                <div className="person">
                  <figure className="quote-avatar">
                    <img src={elonMusk} className="avatar" alt="person" />
                  </figure>
                  <blockquote>
                    <p className="quote-content">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Cum reiciendis eveniet suscipit, totam doloribus iure
                      quasi quos, quidem quam labore pariatur nesciunt rem unde
                      odio a ex vel ullam, quis!
                    </p>
                    <footer>
                      <cite
                        style={{
